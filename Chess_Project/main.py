...
def main():
    ...
    if __name__ == "__main__":
        main()valid moves.
    - Draws the chessboard, pieces, turn indicator, and highlights legal moves.
    - Animates piece movement when a move is made.

    Dependencies:
    - Pygame library for rendering and event handling.
    - GameManager class for managing game logic.
    - Helper functions for loading images, drawing elements, and animating moves.

    Exits the game loop and quits Pygame when the user closes the window.
